 ...
 * окнчаивающиеся на 5, 0 гарантированно делятся на 5. Числа, оканчивающиеся на
 * 1, 3, 7, 9 необходимо проверять. Будем проверять только их.
 * 
 * Неоптимизированная версия - делители перебираются полным перебором.
 * 
 * @author bratishka
 * @version 1.0
 */
